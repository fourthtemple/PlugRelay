class PlugRelayAudioProcessor extends AudioWorkletProcessor {
  constructor(options) {
    super();
  ...
  process(inputs, outputs) {
    ...
    if (this.blockId % this.statsIntervalBlocks === 0) {
      ...
      this.port.postMessage({
        ...
        sharedInputQueuedBlocks: this.sharedAudio ? Atomics.load(this.sharedAudio.inputControl, PlugRelayAudioProcessor.sharedAvailable) : 0,
        sharedInputQueuedMaxBlocks: this.sharedInputQueuedMaxBlocks,
        sharedOutputQueuedBlocks: this.sharedAudio ? Atomics.load(this.sharedAudio.outputControl, PlugRelayAudioProcessor.sharedAvailable) : 0,
  ...
  sharedSlotMetadataOffset(slotIndex) { return PlugRelayAudioProcessor.sharedHeaderInts + slotIndex * PlugRelayAudioProcessor.sharedSlotInts; }
...
PlugRelayAudioProcessor.sharedHeaderInts = 8;
PlugRelayAudioProcessor.sharedSlotInts = 4;
PlugRelayAudioProcessor.sharedWriteIndex = 0;
PlugRelayAudioProcessor.sharedReadIndex = 1;
PlugRelayAudioProcessor.sharedAvailable = 2;
PlugRelayAudioProcessor.sharedDropped = 3;
PlugRelayAudioProcessor.sharedSlots = 4;
PlugRelayAudioProcessor.sharedChannels = 5;
PlugRelayAudioProcessor.sharedFrames = 6;
PlugRelayAudioProcessor.sharedVersion = 7;
PlugRelayAudioProcessor.sharedBlockIdOffset = 0;
PlugRelayAudioProcessor.sharedBlockFramesOffset = 1;
PlugRelayAudioProcessor.sharedBlockChannelsOffset = 2;
