...
- VST3: installed audio effects through the Steinberg VST3 SDK host worker, including parameter metadata, parameter writes, bounded automation event lists, bounded note/poly-pressure events, VST3 MIDI-controller parameter mapping where plugins expose it, negotiated per-bus layout reporting, rendering, bounded latency/tail reporting, and opaque state save/restore.
