...
Use `rack.setParameter()`, `rack.setParameterEvents()`, `rack.setParameterCurve()`, `rack.setPreset()`, and `rack.sendMidiEvents()` to drive the rack-owned plugin instance from live controls without passing raw instance ids around the host.
