...
For live UIs, read `pluginNode.health` from your meter/failover loop to monitor transport latency, deadline misses, stale output, dropped input, underruns, audio errors, and render-budget pressure.
