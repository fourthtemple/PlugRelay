...
- Add LV2 extension-state, worker, UI, and extension-feature support behind the same worker, validation, state, bus, file-broker, and sandbox rules. Basic LV2 control-port state and bounded atom MIDI delivery are already supported for compatible plugins.
