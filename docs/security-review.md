...
| Full plugin-hosting surface | Open roadmap | AU offline/splitter/format-converter profiles, remaining VST3 bus/program-data/note-expression edge cases, LV2 UI and advanced extension support, plugin UI, and broader file access need feature-specific controls as they are implemented. |
