...
| Full plugin-hosting surface | Open roadmap | Automation curve interpolation, AU/LV2 sidechain and multi-output routing, deeper VST3 bus negotiation and factory metadata, LV2 extension-state/worker/UI support, plugin UI, and file access need feature-specific controls as they are implemented. |
