...
- Tune the `SharedArrayBuffer` ring path for sustained live sets, including ring-depth policy, underrun recovery, fallback timer behavior, and measured jitter reporting.
