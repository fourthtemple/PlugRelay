...
- binary WebSocket audio frames for main-bus and bus-indexed `processAudioBlock` buffers used by the web client and live effect rack, with typed-buffer decode through daemon normalization and native-worker command encoding
