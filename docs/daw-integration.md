...
- call `SoundBridgeAudioNode.setBypassed(true)` for Web Audio graph emergency fail-dry paths instead of destroying and recreating the plugin instance during a live set
